<div id="page-wrapper">
    <!--<div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Create New Income Head</h2>
        </div>
    </div>-->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="">Create New Income Head</h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <form id="create_income_head_form" name="create_income_head_form"
                                  action="<?= base_url('accounts/income_head/save_income_head') ?>" method="post">
                                ...
                                <?php if (!empty($this->session->flashdata('income_head_name_duplicate_error_message'))) { ?>
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-xs-12 col-form-label"></label>

                                        <div class="col-sm-10 col-xs-12 error-message">
                                            <?= $this->session->flashdata('income_head_name_duplicate_error_message') ?>
                                        </div>
                                    </div>
                                <?php } ?>
...
<script>
    $(document).ready(function () {
        $("form[name='create_income_head_form']").validate({
