<div id="envelope-print-information" style="margin-top: 60%; margin-left: 20%">
    <style>
        @page{
            size: auto;   
            margin: 0mm; 
    ...
    <?php if (empty($envelope_print->from_envelope_details) || $envelope_print->from_envelope_details == NULL) { ?>
        <table class="vertical" style="margin-top: 60%; margin-left: 20%">
            <thead>
            <th></th>
            </thead>
            <tbody>
    ...
    <table class="vertical">
            <tr>
                <td>
                    <div class="envelope_container text_font_size" style="width: 100%; margin-left: 95%; margin-top: -5%"> <?= !empty($envelope_print->envelope_title) ? $envelope_print->envelope_title : '' ?></div>
                </td>
            </tr>
        </table>
