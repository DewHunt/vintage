<div id="page-wrapper">
    <div class="card-margin-top">
        ...
        <div class="create-new-button">
            <?php echo anchor(base_url('accounts/narration/create_new_narration'), '<i class=" fa fa-plus" aria-hidden="true"></i> Add New Narration', 'class="btn btn-primary create-new-button"') ?>
        </div>
                            ...
                            <table class="table table-striped" id="details-table">
                                ...
                                foreach ($narration_list as $narration): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url("accounts/narration/update_narration/$narration->id") ?>"
