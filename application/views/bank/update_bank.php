        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="">Update Bank Information</h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <form id="update_bank_form" name="update_bank_form"
                                  action="<?= base_url('bank/update') ?>" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 col-xs-12">
                                        <input type="text" class="form-control" id="bank_name" name="bank_name"
                                               value="<?= $bank->bank_name ?>" placeholder="Bank Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 col-xs-12">
                                        <input type="text" class="form-control" id="branch_name" name="branch_name"
                                               value="<?= $bank->branch_name ?>" placeholder="Branch Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 col-xs-12">
                                        <input type="text" class="form-control" id="branch_location"
                                               ...
                                               value="<?= $bank->branch_location ?>" placeholder="Branch Location">
                                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $("form[name='update_bank_form']").validate({
            rules: {
                bank_name: "required",
