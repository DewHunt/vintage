<div id="page-wrapper">
    <div class="row card-margin-top">
        <div class="create-new-button">
            <?php echo anchor(base_url('employee_own_leave_application'), '<i class=" fa fa-reply-all" aria-hidden="true"></i> My Leave Application List', 'class="btn btn-primary create-new-button"') ?>
        </div>
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php if (!empty($this->session->flashdata('employee_own_leave_application_date_error_message'))) { ?>
                        <div class="error error-message text-align-center">
                            <?php echo $this->session->flashdata('employee_own_leave_application_date_error_message'); ?>
                        </div>
                    <?php }
                    ?>
                    <?php if (!empty($this->session->flashdata('employee_own_leave_application_save_success_message'))) { ?>
                        <div class="error success-message text-align-center">
                            <?php echo $this->session->flashdata('employee_own_leave_application_save_success_message'); ?>
                        </div>
                    <?php }
                    ?>
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <form id="employee_own_leave_application_form" name="employee_own_leave_application_form" action="<?= base_url('employee_own_leave_application/employee_own_leave_application_save') ?>" method="post">
                                            ...
                                            <tr>
                                                <td class="left-side-view col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="col-sm-10 col-xs-12">
                                                        <input type="text" class="form-control" id="employee_name" name="employee_name" value="<?= !empty($employee->employee_name) ? ucfirst($employee->employee_name) : '' ?>" placeholder="Employee Name" readonly="readonly">
                                                    </div>
                                                </td>
                                                <td class="right-side-view col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" id="employee_code" name="employee_code" value="<?= !empty($employee->employee_code) ? $employee->employee_code : '' ?>" placeholder="Employee Code" readonly="readonly">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="left-side-view col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="col-sm-5 col-xs-12">
                                                        <input type="date" class="form-control div-margin-top" id="start_date" name="start_date" value="" placeholder="">
                                                    </div>
                                                    <div class="col-sm-5 col-xs-12">
                                                        <input type="date" class="form-control div-margin-top" id="end_date" name="end_date" value="" placeholder="">
                                                    </div>
                                                </td>
                                                <td class="right-side-view col-xs-12 col-sm-6">
                                                    <label for="designation" class="col-sm-3 col-xs-12 col-form-label div-margin-top">Designation</label>
                                                    <div class="col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control div-margin-top" id="designation" name="designation" value="<?= !empty($employee->designation) ? $employee->designation : '' ?>" placeholder="Designation" readonly="readonly">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="right-side-view col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control div-margin-top" id="mobile" name="mobile" value="<?= !empty($employee->mobile) ? $employee->mobile : '' ?>" placeholder="mobile" readonly="readonly">
                                                    </div>
                                                </td>
                                            </tr>
...
<script>
    $(document).ready(function () {
        ...
        $("#employee_own_leave_application_form").validate({
            rules: {
                start_date: "required",
                end_date: "required",
                leave_type: "required",
