<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"><h4 class="">Customer Payment</h4></div>
            </div>
        </div>

        <div class="panel-body custom-panel-body">
            <div class="form-block">
                <form id="customer_payment_form" name="customer_payment_form" action="<?= base_url('customer_payment/show/') ?>" method="post">
                    <div class="row">
