<div id="page-wrapper">
    ...
    <form id="addForm" name="addForm" action="<?= base_url('product_transfer/save') ?>" method="post" enctype="multipart/form-data">
        <div class="panel panel-default custom-panel">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><h4 class="">Add Product Transfer</h4></div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control select2" id="branch" name="branch">
                                                ...
                                                <?php foreach ($allBrnach as $branch): ?>
...
<script type="text/javascript">
    $(document).ready(function (){
        $(document.body).on('change', '#productType', function (){
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url("product_transfer/get_product_info_by_product_type/") ?>',
    ...
    function addTrasferProduct() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url("product_transfer/add_transfer_product/") ?>',
