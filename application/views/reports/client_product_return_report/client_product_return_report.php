        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="">Client Product (Return) Report</h4>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">

                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 client_product_return_report_form_block">

                            <form id="client_details_ledger_report_form" name="client_details_ledger_report_form"
                                  action="<?= base_url('reports/client_product_return_report/client_product_return_report_show_in_table') ?>"
                                  method="post">
                            ...
                            <div class="col-xs-12 client_product_return_report_table">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.client_product_return_report_form_block form').submit(function (event) {
            event.preventDefault();
            $.post($(this).attr('action'), $(this).serialize(), function (data) {
                $(".client_product_return_report_table").html(data);
            });
        });
    });
</script>
