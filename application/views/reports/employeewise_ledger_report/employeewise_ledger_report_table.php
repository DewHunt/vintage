...
//    echo '<pre>';
//    print_r($employeewise_client_ledger_report);
//    echo '</pre>';
//   // die();
    ?>
    ...
    <table class="table table-striped" style="width: 100%" id="details-table">
        ...
        <tbody>
            ...
            // if (!empty($employeewise_client_ledger_report)) {
            ?>
            <?php foreach ($employeewise_client_ledger_report as $all_client_individual_details) { ?>
                ...
                <tr>
                    <td><?= $count++ ?></td>
                    <td><?= $all_client_individual_details['employee_name'] ?></td>
                    <td class="text-right"><?= number_format((double) abs($all_client_individual_details['opening_balance']), 2) ?></td>
                    <!--debit change into credit and credit change into debit-->
                    <td class="text-right"><?= number_format((double) abs($all_client_individual_details['total_credit_amount']), 2) ?></td>
                    <td class="text-right"><?= number_format((double) abs($all_client_individual_details['total_debit_amount']), 2) ?></td> 
                    <?php if ((double) $all_client_individual_details['closing_balance'] < 0) { ?>
                        <td class="text-right text-color-red"><?= number_format((double) abs($all_client_individual_details['closing_balance']), 2) ?></td>
                    <?php } else { ?>
                        <td class="text-right"><?= number_format((double) abs($all_client_individual_details['closing_balance']), 2) ?></td>
                    <?php } ?>
                </tr>
