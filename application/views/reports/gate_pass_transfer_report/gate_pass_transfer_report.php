        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="">Gate Pass Report (Transfer)</h4>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 stock-transfer-challan-report-form-block">
                            ...
                            <form id="stock_transfer_table_form" name="stock_transfer_table_form" action="<?= base_url('reports/gate_pass_transfer_report/stock_transfer_challan_report_show_in_table') ?>" method="post">
