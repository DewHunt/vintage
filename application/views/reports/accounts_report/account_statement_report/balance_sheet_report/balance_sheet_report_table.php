    ...
    <?php if ((strtolower($user_type) != 'marketing')) { ?>
        <?php if (!empty($print_access) > 0) { ?>
            <div class="col-xs-12 col-sm-4">
                <button type="button" class="btn btn-primary balance-sheet-account-report-print-button report-print-button"><i class="fa fa-print" aria-hidden="true"></i> Print</button>
            </div>
            <?php
        }
    }
    ...
    <div class="form-group table-responsive" style="margin-top: 5%">
        <table class="table table-bordered table-striped" style="width: 100%" id="details-table">
            ...
            <tbody>
                ...
                $profit_and_loss_appropriation_balance_dr = 0;
                $profit_and_loss_appropriation_balance_cr = 0;
                ?>
                <?php if (!empty(abs($profit_and_loss_appropriation_balance_profit_or_loss)) || !empty(abs($profit_and_loss_appropriation_balance_profit_or_loss))) { ?>
                    <?php if (abs($profit_and_loss_appropriation_balance_profit_or_loss[0]['total_dr']) >= abs($profit_and_loss_appropriation_balance_profit_or_loss[0]['total_cr'])) { ?>
                        <?php $profit_and_loss_account_balance_dr = abs((double) $profit_and_loss_appropriation_balance_profit_or_loss[0]['total_dr']) ?>
                        <tr>
                            <td class="text-align-right"></td>
                            <td class="text-align-right"></td>
                            <td class="text-align-left">Profit and Loss Appropriation</td>
                            <td class="text-align-right"><?= get_floating_point_number(abs($profit_and_loss_appropriation_balance_profit_or_loss[0]['total_dr'])) ?></td>  
                        </tr>
                    <?php } else { ?>
                        <?php $profit_and_loss_appropriation_balance_cr = abs((double) $profit_and_loss_appropriation_balance_profit_or_loss[0]['total_cr']) ?>
                        <tr>
                            <td class="text-align-left">Profit and Loss Appropriation</td>
                            <td class="text-align-right"><?= get_floating_point_number(abs($profit_and_loss_appropriation_balance_profit_or_loss[0]['total_cr'])) ?></td>
                            <td class="text-align-right"></td>
                            <td class="text-align-right"></td>
                        </tr>
                    <?php }
                ...
                <tr>
                    <td class="text-align-right"></td>
                    <td class="text-align-right"><strong><?= get_floating_point_number((double) $grand_total_amount_dr + (double) $profit_and_loss_appropriation_balance_cr) ?></strong></td>
                    <td class="text-align-right"></td>
                    <td class="text-align-right"><strong><?= get_floating_point_number((double) $grand_total_amount_cr + (double) $profit_and_loss_appropriation_balance_dr) ?></strong></td>
                </tr>
...
<div id="balance-sheet-account-report-print-information" style="display: none">
    ...
    <div class="col-xs-12" style="text-align: center; font-size: 16px; font-weight: bolder">
        <label class=""><?= strtoupper('Balance Sheet') ?></label>
    </div>
    <div class="col-xs-12" style="text-align: center">
    ...
    <div class="col-xs-12">
        <table class="table table-bordered table-striped" border="2px solid black" cellspacing="0" style="width: 100%" id="details-table">
            ...
            <tbody>
                ...
                <?php if (!empty(abs($profit_and_loss_appropriation_balance_profit_or_loss)) || !empty(abs($profit_and_loss_appropriation_balance_profit_or_loss))) { ?>
                    <?php if (abs($profit_and_loss_appropriation_balance_profit_or_loss[0]['total_dr']) >= abs($profit_and_loss_appropriation_balance_profit_or_loss[0]['total_cr'])) { ?>
                        ...
                        <tr style="line-height: 30px; border: thick">
                            ...
                            <td class="text-align-right"></td>
                            <td class="text-align-left">Profit and Loss Appropriation</td>
                            <td class="text-align-right" style="text-align: right"><?= get_floating_point_number(abs($profit_and_loss_appropriation_balance_profit_or_loss[0]['total_dr'])) ?></td>  
                        </tr>
                    <?php } else { ?>
                        <?php $profit_and_loss_appropriation_balance_cr = abs((double) $profit_and_loss_appropriation_balance_profit_or_loss[0]['total_cr']) ?>
                        <tr style="line-height: 30px; border: thick">
                            <td class="text-align-left">Profit and Loss Appropriation</td>
                            <td class="text-align-right" style="text-align: right"><?= get_floating_point_number(abs($profit_and_loss_appropriation_balance_profit_or_loss[0]['total_cr'])) ?></td>
                            <td class="text-align-right"></td>
                            <td class="text-align-right"></td>
                        </tr>
                    <?php }
                ...
                <tr style="line-height: 30px; border: thick">
                    <td class="text-align-right"></td>
                    <td class="text-align-right" style="text-align: right"><strong><?= get_floating_point_number($grand_total_amount_dr + $profit_and_loss_appropriation_balance_cr) ?></strong></td>
                    <td class="text-align-right"></td>
                    <td class="text-align-right" style="text-align: right"><strong><?= get_floating_point_number($grand_total_amount_cr + $profit_and_loss_appropriation_balance_dr) ?></strong></td>
                </tr>
            </tbody>                
        </table>
    </div>
...
<script language="javascript" type="text/javascript">
    ...
    $(".balance-sheet-account-report-print-button").on("click", function () {

        var divContents = $('#balance-sheet-account-report-print-information').html();
