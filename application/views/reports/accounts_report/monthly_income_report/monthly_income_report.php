        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="">Monthly Income Report(Received Side)(Cr)</h4>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">

                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 monthly-income-report-block">

                            <form id="monthly_income_report_form" name="monthly_income_report_form" action="<?= base_url('reports/accounts_report/monthly_income_report/monthly_income_report_show_in_table') ?>" method="post">
                            ...
                            <div class="col-xs-12 monthly-income-report-table">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.monthly-income-report-block form').submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $(".monthly-income-report-table").html(data);
                },
                beforeSend: function () {
                    $('.loading-image').show();
