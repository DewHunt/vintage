        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="">Head Details Report</h4>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="col-xs-12 employee-benefit-report-form-block">
                        <form class="" name="branch-stock-report" method="post"
                              action="<?= base_url('reports/accounts_report/head_details_report/head_details_report_show_in_table') ?>">
                        ...
                        <div class="col-xs-12 head_details_report_table">
    ...
    $(document).ready(function () {
        $('.employee-benefit-report-form-block form').submit(function (event) {
            ...
            $.post($(this).attr('action'), $(this).serialize(), function (data) {
                $(".head_details_report_table").html(data);
            });
        });
    });
</script>
