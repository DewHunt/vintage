        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-xs-12 incentive-report-form-block">
                        <form id="incentive-report-form" class="incentive-report-form" name="incentive-report" method="post" action="<?= base_url('reports/sales_department_reports/incentive_report/incentive_report_show_in_table') ?>">
...
//                    console.log('Month: ' + m + ', year: ' + y);
        ...
        $('.incentive-report-form-block form').submit(function (event) {
            event.preventDefault();
            var formClassName = 'incentive-report-form';
            ...
            if (isValid) {
                $.ajax({
                    ...
                    success: function (data) {
                        $(".incentive-report-table").html(data);
                    },
                    error: function () {
