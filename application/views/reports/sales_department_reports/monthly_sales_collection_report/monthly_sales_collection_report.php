        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-xs-12 monthly-sales-collection-report-form-block">
                        <form id="monthly-sales-collection-report-form" class="monthly-sales-collection-report-form" name="monthly-sales-collection-report" method="post" action="<?= base_url('reports/sales_department_reports/monthly_sales_collection_report/monthly_sales_collection_report_show_in_table') ?>">
                        ...
                        <div class="monthly-sales-collection-report-table">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.monthly-sales-collection-report-form-block form').submit(function (event) {
            event.preventDefault();
            var formClassName = 'monthly-sales-collection-report-form';
            ...
            if (isValid) {
                $.ajax({
                    ...
                    success: function (data) {
                        $(".monthly-sales-collection-report-table").html(data);
                    },
                    error: function () {
