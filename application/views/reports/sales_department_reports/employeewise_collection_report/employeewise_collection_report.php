            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-xs-12 outstanding-report-form-block">
                        <form id="outstanding-report-form" class="outstanding-report-form" name="outstanding-report" method="post" action="<?= base_url('reports/sales_department_reports/employeewise_collection_report/employeewise_collection_report_show_in_table') ?>">
