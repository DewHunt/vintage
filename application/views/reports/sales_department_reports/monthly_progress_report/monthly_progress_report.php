        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-xs-12 monthly-progress-report-form-block">
                        <form id="monthly-progress-report-form" class="monthly-progress-report-form" name="monthly-progress-report" method="post" action="<?= base_url('reports/sales_department_reports/monthly_progress_report/monthly_progress_report_show_in_table') ?>">
                        ...
                        <div class="monthly-progress-report-table">
...
//                    console.log('Month: ' + m + ', year: ' + y);
        ...
        $('.monthly-progress-report-form-block form').submit(function (event) {
            event.preventDefault();
            var formClassName = 'monthly-progress-report-form';
            ...
            if (isValid) {
                $.ajax({
                    ...
                    success: function (data) {
                        $(".monthly-progress-report-table").html(data);
                    },
                    error: function () {
