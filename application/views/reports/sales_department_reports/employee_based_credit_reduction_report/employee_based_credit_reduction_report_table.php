        ...
        <div class="table-responsive table-bordered" style="width: 100%;">
            ...
            if (!empty($employee_based_credit_reduction_report)) {
                foreach ($employee_based_credit_reduction_report as $credit_reduction_report) {
                    $employee = $credit_reduction_report['employee'];
                    $report_array = $credit_reduction_report['report_array'];
                    ?>
                    <table class="table table-striped" id="details-table1">
                        <thead>
                            <tr>
                                <th><?= !empty($employee->employee_name) ? $employee->employee_name : ''; ?></th>
                        ...
                        <tbody>
                            ...
                            if (!empty($report_array)) {
                                foreach ($report_array as $report) {
                                    ...
                                    <tr>
                                        <td><?= $month_year; ?></td>
                                        <td class="text-right"><?= ($opening_balance >= 0) ? $minus_sign_text . (get_floating_point_number(($opening_balance), TRUE) . $cr_text) : $plus_sign_text . (get_floating_point_number(($opening_balance), TRUE) . $dr_text); ?></td>
                            ...
                            ?>
                            <?php
                            $sum_of_credit_reduction = (($overall_opening_balance) - $overall_closing_balance);
                            ?>
                            <tr>
                        ...
                        if (!empty($report_array)) {
                            foreach ($report_array as $report) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><?= get_floating_point_number($sale_amount, TRUE) ?></td>
                                    <td class="text-right"><?= get_floating_point_number($collection_amount, TRUE) ?></td>
                                    <td class="text-right"><?= get_floating_point_number(abs($overall_closing_balance), TRUE) ?></td>
                                    <td class="text-right"><?= ($credit_reduction >= 0) ? $plus_sign_text . (get_floating_point_number(abs($credit_reduction), TRUE) . $dr_text) : $minus_sign_text . (get_floating_point_number(abs($credit_reduction), TRUE) . $cr_text) ?></td>
                                </tr>
                                <?php
                                $count++;
