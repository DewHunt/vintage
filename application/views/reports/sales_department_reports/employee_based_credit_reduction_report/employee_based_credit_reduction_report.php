        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-xs-12 employee-based-credit-reduction-report-form-block">
                        <form id="employee-based-credit-reduction-report-form" class="employee-based-credit-reduction-report-form" name="employee-based-credit-reduction-report" method="post" action="<?= base_url('reports/sales_department_reports/employee_based_credit_reduction_report/employee_based_credit_reduction_report_show_in_table') ?>">
                        ...
                        <div class="employee-based-credit-reduction-report-table">
...
//                    console.log('Month: ' + m + ', year: ' + y);
        ...
        $('.employee-based-credit-reduction-report-form-block form').submit(function (event) {
            event.preventDefault();
            var formClassName = 'employee-based-credit-reduction-report-form';
            ...
            if (isValid) {
                $.ajax({
                    ...
                    success: function (data) {
                        $(".employee-based-credit-reduction-report-table").html(data);
                    },
                    error: function () {
