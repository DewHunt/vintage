        ...
        <table class="table table-striped" id="details-table">
            <thead>
                <tr>
                    ...
                    <th class="text-right">Avg Sale of (<?= $month_duration_count . ' Month(s)' ?>)</th>
                    <th class="text-right">Credit Month</th>
            ...
            <tbody>
                ...
                if (!empty($outstanding_report)) {
                    foreach ($outstanding_report as $report) {
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?= ($closing_amount >= 0) ? (get_floating_point_number(abs($closing_amount), TRUE) . $dr) : (get_floating_point_number(abs($closing_amount), TRUE) . $cr); ?></td>
                            <td class="text-right"></td>
                            <td class="text-right"><?= get_floating_point_number($average_sale_amount, TRUE) ?></td>
                            <td class="text-right"><?= ($average_sale_amount == 0) ? (($closing_amount == 0) ? 0 : get_infinite_sign()) : ((($closing_amount / $average_sale_amount) >= 0) ? (get_floating_point_number(abs($closing_amount / $average_sale_amount), TRUE) . $dr) : (get_floating_point_number(abs($closing_amount / $average_sale_amount), TRUE) . $cr)); ?></td>
                ...
                <tr>
                    ...
                    <td class="text-right"><strong><?= ($sum_of_closing_amount >= 0) ? (get_floating_point_number(abs($sum_of_closing_amount), TRUE) . $dr) : (get_floating_point_number(abs($sum_of_closing_amount), TRUE) . $cr); ?></strong></td>
                    <td class="text-right"><strong></strong></td>
                    <td class="text-right"><strong><?= get_floating_point_number($sum_of_average_sale_amount, TRUE); ?></strong></td>
<!--                    <td class="text-right"><strong><?= ($sum_of_credit_month >= 0) ? (get_floating_point_number(abs($sum_of_credit_month), TRUE) . $dr) : (get_floating_point_number(abs($sum_of_credit_month), TRUE) . $cr) ?></strong></td>-->
                    <td class="text-right"><strong><?= ($sum_of_closing_amount != 0) ? get_floating_point_number(abs($sum_of_closing_amount / $sum_of_average_sale_amount)) : get_floating_point_number(0); ?></strong></td>
                    <td class="text-right"><strong></strong></td>
                </tr>
            </tbody>
        </table>
        ...
        <tbody>
            ...
            if (!empty($outstanding_report)) {
                foreach ($outstanding_report as $report) {
                    ...
                    $sum_of_collection_amount += $collection_amount;
                    $closing_amount = get_floating_point_number(($opening_balance + $sale_amount) - $collection_amount);
                    $closing_amount = get_floating_point_number(abs($closing_amount));
                    $sum_of_closing_amount += $closing_amount;
                    $average_sale_amount = ($sale_amount > 0) ? ($sale_amount / $month_duration_count) : 0;
                    $sum_of_average_sale_amount += $average_sale_amount;
                    $credit_month = ($average_sale_amount > 0) ? ($closing_amount / $average_sale_amount) : 0;
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?= get_floating_point_number($collection_amount, TRUE) ?></td>
                        <td class="text-right"><?= ($closing_amount >= 0) ? (get_floating_point_number(abs($closing_amount), TRUE) . $dr) : (get_floating_point_number(abs($closing_amount), TRUE) . $cr); ?></td>
                        <td class="text-right" style="min-width: 50px;"></td>
                        <td class="text-right"><?= get_floating_point_number($average_sale_amount, TRUE) ?></td>
                        <td class="text-right"><?= ($average_sale_amount == 0) ? (($closing_amount == 0) ? 0 : get_infinite_sign()) : ((($closing_amount / $average_sale_amount) >= 0) ? (get_floating_point_number(abs($closing_amount / $average_sale_amount), TRUE) . $dr) : (get_floating_point_number(abs($closing_amount / $average_sale_amount), TRUE) . $cr)); ?></td>
