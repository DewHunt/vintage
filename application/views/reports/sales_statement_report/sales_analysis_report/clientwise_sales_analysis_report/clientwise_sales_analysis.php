...
<div class="width-100">
    <form id="clientwise-sales-analysis-form" class="clientwise-sales-analysis-form" method="post" accept-charset="" action="<?= base_url('reports/sales_statement_report/sales_analysis_report/clientwise_sales_analysis_report/analysis_report'); ?>">
    ...
    <div id="bar-chart-block" class="col-xs-12">
        <?php $this->load->view('reports/sales_statement_report/sales_analysis_report/clientwise_sales_analysis_report/clientwise_sales_analysis_bar_chart', $this->data); ?>
    </div>    
</div>

<script type="text/javascript">
    $(document).ready(function () {
        $('.clientwise-sales-analysis-form').submit(function (event) {
            event.preventDefault();
            var formClassName = 'clientwise-sales-analysis-form';
