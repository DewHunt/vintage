        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-xs-12 sales-commission-form-block">
                        <form id="sales-commission-form" class="sales-commission-form" name="branch-stock-report" method="post" action="<?= base_url('reports/sales_statement_report/sales_commission_report/sales_commission_report_show') ?>">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.sales-commission-form-block form').submit(function (event) {
            event.preventDefault();
            var formClassName = 'sales-commission-form';
