        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-xs-12 sales-pfofit-report-invoicewise-form-block">
                        <form id="sales-pfofit-report-invoicewise-form" class="sales-pfofit-report-invoicewise-form" name="branch-stock-report" method="post" action="<?= base_url('reports/sales_statement_report/sales_pfofit_report_invoicewise/sales_pfofit_report_invoicewise_show') ?>">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.sales-pfofit-report-invoicewise-form-block form').submit(function (event) {
            event.preventDefault();
            var formClassName = 'sales-pfofit-report-invoicewise-form';
