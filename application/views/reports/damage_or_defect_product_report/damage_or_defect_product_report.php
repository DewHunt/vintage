        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="">Product (Damage / Defect) Report</h4>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">

                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 damage_or_defect_product_form_block">

                            <form id="client_details_ledger_report_form" name="client_details_ledger_report_form"
                                  action="<?= base_url('reports/damage_or_defect_product_report/damage_or_defect_product_report_show_in_table') ?>"
                                  method="post">
                            ...
                            <div class="col-xs-12 damage_or_defect_product_table">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.damage_or_defect_product_form_block form').submit(function (event) {
            event.preventDefault();
            $.post($(this).attr('action'), $(this).serialize(), function (data) {
                $(".damage_or_defect_product_table").html(data);
            });
        });
    });
</script>
