        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="">Client Details Ledger Report</h4>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">

                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 client-details-ledger-report-form-block">

                            <form id="client_details_ledger_report_form" name="client_details_ledger_report_form"
                                  action="<?= base_url('reports/client_details_ledger_report/client_details_ledger_report_show_in_table') ?>"
                                  method="post">
                            ...
                            <div class="col-xs-12 client-details-ledger-report-table">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.client-details-ledger-report-form-block form').submit(function (event) {
            event.preventDefault();
            $.post($(this).attr('action'), $(this).serialize(), function (data) {
                $(".client-details-ledger-report-table").html(data);
            });
        });
    });
</script>
