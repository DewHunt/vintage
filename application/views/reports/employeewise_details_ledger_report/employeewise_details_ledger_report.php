                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 employee-details-ledger-report-form-block">
                            <form id="employee_details_ledger_report_form" name="employee_details_ledger_report_form" action="<?= base_url('reports/employeewise_details_ledger_report/employeewise_details_ledger_report_show_in_table') ?>" method="post">
