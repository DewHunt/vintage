<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-md-6"><h4 class="">Product Purchase</h4></div>
                <div class="col-md-6 text-right">
                    <a href="<?= base_url('product_purchase/add') ?>" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New Product Purchase</a>
                </div>
            </div>
        </div>
        <!-- /.panel-heading -->
