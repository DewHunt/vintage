<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"><h4 class="">Customer Bill</h4></div>
            </div>
        </div>

        <div class="panel-body custom-panel-body">
            <div class="form-block">
                <form id="customer_bill_form" name="customer_bill_form" action="<?= base_url('customer_bill/show/') ?>" method="post">
                    <div class="row">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="customer-bill-table">
                <?php
                    $this->data['customerBillList'] = $customerBillList;
                    echo $this->load->view('customer_bill/customer_bill_table',$this->data,true);
                ?>
            </div>
        </div>
    </div>

    <div class="modal fade" id="customerBillInfoModal" role="dialog" data-backdrop="static" data-keyboard="false">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.form-block form').submit(function (event) {
            ...
            $.post($(this).attr('action'), $(this).serialize(), function (data) {
                $(".customer-bill-table").html(data.output);
            });
        });
    ...
    function viewCustomeBillInfo(clientId,startDate,endDate) {
        $.ajax({
            type: "POST",
            url: '<?= base_url("customer_bill/view/") ?>',
            data: {clientId:clientId,startDate:startDate,endDate:endDate},
            success: function (data) {
                $('.modal-body').html(data.output);
                $('#customerBillInfoModal').modal('show');
            },
            error: function () {
