<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"><h4 class="">Purchase Statement</h4></div>
            </div>
        </div>

        <div class="panel-body custom-panel-body">
            <div class="purchase-statement-form-block">
                <form id="invoice_report_form" name="invoice_report_form" action="<?= base_url('purchase_statement/show/') ?>" method="post">
                    <div class="row">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="purchase-statement-table"></div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.purchase-statement-form-block form').submit(function (event) {
            ...
            $.post($(this).attr('action'), $(this).serialize(), function (data) {
                $(".purchase-statement-table").html(data.output);
            });
        });
    ...
    function viewPurchasedProductInfo(purchasedProductId) {
        $.ajax({
            type: "POST",
            url: '<?= base_url("purchase_statement/view/") ?>',
