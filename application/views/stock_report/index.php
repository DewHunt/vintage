<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><h4 class="">Stock Report</h4></div>
            </div>            
        </div>
        <!-- /.panel-heading -->
        <div class="panel-body">
            <div class="stock-report-form-block">
                <form id="stock_report_form" name="stock_report_form" action="<?= base_url('stock_report/show') ?>" method="post">
                    <div class="row">
                        <div class="col-lg-10 col-md-10 col-sm-5 col-xs-12" style="padding: 0px 5px;">
                            <label>Date</label>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="stock-report-table"></div>
        </div>
    </div>
    ...
    $(document).ready(function () {
        $('.stock-report-form-block form').submit(function (event) {
            ...
            $.post($(this).attr('action'), $(this).serialize(), function (data) {
                $(".stock-report-table").html(data.output);
            });
        });
