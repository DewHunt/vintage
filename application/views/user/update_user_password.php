<?php $user_id = !empty($user->id) ? intval($user->id) : 0; ?>
<div id="page-wrapper">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-xs-12 col-md-6">
                        <h4 class="">Change User Password</h4>
                    </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <form id="update_my_password_form" name="update_my_password_form" action="<?= base_url('user/update_password') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-xs-12 row">
                                    <div class="form-group col-xs-12">
                                        <button type="submit" class="btn btn-default save-button" style="margin-left: 10px;">Update</button>
                                        <a type="button" href="<?= base_url('user/update_user/' . $user_id); ?>" class="btn btn-danger cancel-button">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
