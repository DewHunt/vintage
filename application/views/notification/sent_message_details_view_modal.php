        ...
        <div class="col-xs-12">
            ...
            <div class="col-xs-12 col-sm-12">
                ...
                <div class="form-group col-xs-12">
                    ...
                    <label for="message"
                           class="col-xs-12 col-form-label creator-color"><strong class="head-font">Creator:</strong><?= (!empty($creator_by_notification_id)) ? ucfirst($creator_by_notification_id->user_name) : '' ?>
                    </label>
