<div class="card card-boarder">
    ...
    <?php
    $employee_all_received_message;  // for top 5 message
    $employee_total_received_message;  // for all message
    ?>
    <div style="width: 100%;">
        <?php $count = 1;
        ...
        <button class="btn btn-primary btn-block received_message_view_all_button"
                data-toggle="tooltip" data-placement="bottom"
                title="View Details"
                data-id="<? ?>"
    ...
    <div class="modal fade view_all_received_message_modal">
        <div class="modal-dialog view_all_received_message_show " role="document">

        </div>
    </div>

    <div class="modal fade received_message_details_view_modal">
        <div class="modal-dialog received_message_details_show " role="document">
        </div>
    </div>
