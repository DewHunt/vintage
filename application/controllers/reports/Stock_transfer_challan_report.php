...
class Stock_transfer_challan_report extends CI_Controller {
    ...
    public function index() {
        if (!empty($this->session->userdata('user_session')) && (($this->User_Model->get_user_permission('sales_report_access')) == true)) {
            ...
            $this->load->view('reports/stock_transfer_challan_report/stock_transfer_challan_report', $this->data);
        } else {
    ...
    public function stock_transfer_challan_report_show_in_table() {
        if (!empty($this->session->userdata('user_session')) && (($this->User_Model->get_user_permission('sales_report_access')) == TRUE)) {
            ...
            $this->load->view('reports/stock_transfer_challan_report/stock_transfer_challan_report_table', $this->data);
        } else {
            redirect(base_url('user_login'));
        }
    }
    ...
    public function stock_transfer_challan_report_show_in_modal() {  //details show in Modal
        if (!empty($this->session->userdata('user_session')) && (($this->User_Model->get_user_permission('sales_report_access')) == true)) {
            ...
            $this->load->view('reports/stock_transfer_challan_report/stock_transfer_challan_report_modal', $this->data);
        } else {
            redirect(base_url('user_login'));
        }
    }
