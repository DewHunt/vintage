...
class Product_sales_analysis_report extends CI_Controller {
    ...
    public function index() {
        if (!empty($this->session->userdata('user_session')) && (($this->User_Model->is_loggedin_user_type_admin()) == true)) {
            $this->data['title'] = "Product Sales Analysis";
            $this->data['page_title'] = "Product Sales Analysis";
    ...
    public function analysis_report() {
        if (!empty($this->session->userdata('user_session')) && (($this->User_Model->is_loggedin_user_type_admin()) == true)) {
            if ($this->input->is_ajax_request()) {
                ...
                redirect(base_url('reports/sales_statement_report/sales_analysis_report/product_sales_analysis_report'));
            }
        } else {
            redirect(base_url('user_login'));
        }
